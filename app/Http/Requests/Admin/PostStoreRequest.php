...
class PostStoreRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'formData.slug.string' => 'Поле "Ссылка" должно быть строкой.',
            'formData.slug.required' => 'Поле "Ссылка" является обязательным и должно быть уникальным.',
            'formData.slug.unique' => 'Такая "Ссылка" уже используется для другой записи.',
