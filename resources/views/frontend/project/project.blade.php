...
{{--                            <img src="{{asset('images/project/img_31.png')}}" alt=""--}}
{{--                                 class="project-widget2__container-img">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget2-item">--}}
{{--                            <img src="{{asset('images/project/img_32.png')}}" alt=""--}}
{{--                                 class="project-widget2__container-img">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                    </div>--}}
{{--                    <p class="project-widget1-text">Работая с частными и коммерческими клиентами на территории России и--}}
{{--                        других стран - наши специалисты сформировали дружную команду. Благодаря навыкам и мастерству мы--}}
{{--                        способны успешно преобразует пространство вокруг нас, создавая динамичные и вдохновленные--}}
{{--                        интерьеры для жизни. Работая с частными и коммерческими клиентами на территории России и других--}}
{{--                        стран - наши специалисты сформировали дружную команду . Благодаря навыкам и мастерству мы--}}
{{--                        способны успешно преобразует пространство вокруг нас, создавая динамичные и вдохновленные--}}
{{--                        интерьеры для жизни.</p>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--                            <img src="{{asset('images/project/img_34.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_35.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                        Работая с частными и коммерческими клиентами на территории России и других стран - наши--}}
{{--                        специалисты сформировали дружную команду. Благодаря навыкам и мастерству мы способны успешно--}}
{{--                        преобразует пространство вокруг нас, создавая динамичные и вдохновленные интерьеры для жизни.--}}
{{--                        Работая с частными и коммерческими клиентами на территории России и других стран - наши--}}
{{--                        специалисты сформировали дружную команду . Благодаря навыкам и мастерству мы способны успешно--}}
{{--                        преобразует пространство вокруг нас, создавая динамичные и вдохновленные интерьеры для жизни.--}}
{{--                    </p>--}}
...
{{--                    <div class="project-widget3-container">--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_39.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_40.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                    <div class="project-widget3-container">--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_41.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_42.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    <div class="project-widget3-container">--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_43.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_44.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
...
{{--                    <div class="project-widget3-container">--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_45.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                        <div class="project-widget3__column">--}}
{{--                            <img src="{{asset('images/project/img_46.png')}}" alt=""--}}
{{--                                 class="project-widget3__column-image">--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
        ...
        <div class="container">
            ...
            <div class="project__row">
                <project-item-component
                    :item='@json(['id' => 10, 'title' => 'PROJECT 866', 'preview_image' => asset('images/project/img_47.png')])'></project-item-component>
                <project-item-component
                    :item='@json(['id' => 11, 'title' => 'PROJECT 928', 'preview_image' => asset('images/project/img_48.png')])'></project-item-component>
