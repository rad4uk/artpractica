...
@section('content')
    ...
    <div class="project-preview">
        <div class="container">
            <div class="row">
                <h1 class="project-preview__title">PROJECT 562</h1>
                <div class="project-preview__container">
                    <img src="{{asset('images/project/img_62.png')}}" alt="" class="project-preview__container-img">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="project-preview__container project-scheme">
                    <img src="{{asset('images/project/img_63.png')}}" alt="" class="project-preview__container-img">
                </div>
    ...
    <div class="project-wrapper">
        <div class="project-widget4">
            <div class="container">
                <div class="row">
                    <h3 class="project-widget4-title">ОСНОВНОЙ ЗАЛ</h3>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_64.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_65.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_66.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_67.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget4">
            <div class="container">
                <div class="row">
                    <h3 class="project-widget4-title">БАЛКОН</h3>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_68.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                    <p class="project-widget1-text">
                        Работая с частными и коммерческими клиентами на территории России и других стран - наши специалисты сформировали дружную команду. Благодаря навыкам и мастерству мы способны успешно преобразует пространство вокруг нас, создавая динамичные и вдохновленные интерьеры для жизни. Работая с частными и коммерческими клиентами на территории России и других стран - наши специалисты сформировали дружную команду . Благодаря навыкам и мастерству мы способны успешно преобразует пространство вокруг нас, создавая динамичные и вдохновленные интерьеры для жизни.
                    </p>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_69.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
