...
@section('content')
    ...
    <div class="project-preview">
        <div class="container">
            <div class="row">
                <h1 class="project-preview__title">PROJECT 716</h1>
                <div class="project-preview__container">
                    <img src="{{asset('images/project/img_49.png')}}" alt="" class="project-preview__container-img">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="project-preview__container project-scheme">
                    <img src="{{asset('images/project/img_50.png')}}" alt="" class="project-preview__container-img">
                </div>
    ...
    <div class="project-wrapper">
        ...
        <div class="project-widget1">
            <div class="container">
                <h3 class="project-widget1-title">ТЕРРИТОРИЯ УЧАСТКА</h3>
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_51.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_52.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_53.png')}}" alt="" class="project-widget1__container-img">
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="project-widget5__container">
                        <img src="{{asset('images/project/img_54.png')}}" alt="" class="project-widget5__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget4">
            <div class="container">
                <div class="row">
                    <h3 class="project-widget4-title">ОТКРЫТАЯ ТЕРРАСА С БАССЕЙНОМ</h3>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_55.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_56.png')}}" alt="" class="project-widget1__container-img">
                    </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_57.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_58.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_59.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="project">
        <div class="container">
            ...
            <div class="project__row">
                <project-item-component :item='@json(['id' => 10, 'title' => 'PROJECT 866', 'preview_image' => asset('images/project/img_60.png')])'></project-item-component>
                <project-item-component :item='@json(['id' => 11, 'title' => 'PROJECT 928', 'preview_image' => asset('images/project/img_61.png')])'></project-item-component>
