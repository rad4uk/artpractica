...
@section('content')
    ...
    <div class="project-preview">
        <div class="container">
            <div class="row">
                <h1 class="project-preview__title">PROJECT 788</h1>
                <div class="project-preview__container">
                    <img src="{{asset('images/project/img_70.png')}}" alt="" class="project-preview__container-img">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="project-preview__container project-scheme">
                    <img src="{{asset('images/project/img_71.png')}}" alt="" class="project-preview__container-img">
                </div>
    ...
    <div class="project-wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_72.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_73.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_74.png')}}" alt="" class="project-widget1__container-img">
                    </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_75.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget4">
            <div class="container">
                <div class="row">
                    <h3 class="project-widget4-title">САНУЗЕЛ</h3>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_76.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="project-widget5__container">
                        <img src="{{asset('images/project/img_77.png')}}" alt="" class="project-widget5__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget4">
            <div class="container">
                <div class="row">
                    <h3 class="project-widget4-title">ФИРМЕННЫЙ СТИЛЬ</h3>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget5">
            <div class="container">
                <div class="row">
                    <div class="project-widget5__container">
                        <img src="{{asset('images/project/img_78.png')}}" alt="" class="project-widget5__container-img">
                    </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_79.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="project-widget1">
            <div class="container">
                <div class="row">
                    <div class="project-widget1__container">
                        <img src="{{asset('images/project/img_80.png')}}" alt="" class="project-widget1__container-img">
                    </div>
                </div>
            </div>
        </div>
