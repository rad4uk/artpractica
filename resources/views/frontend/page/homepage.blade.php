...
{{--                    <source srcset="{{asset('images/mainImage_1560.webp')}}" media="(min-width: 1560px)">--}}
            ...
            <div class="screen__wrapper">
                <div class="screen__body">
                    <p class="screen__subtitle">Мы с Вами от проекта до полной реализации</p>
                    <h1 class="screen__title">СТУДИЯ <br>ДИЗАЙН ИНТЕРЬЕРА ПОЛНОГО ЦИКЛА</h1>
                    ...
                    <div class="about__column">
                        <div class="about__column-text">
                            <div class="about__column-item">
                                <p class="column-item-tile">
                                    Разрабатываем дизайн-проекты интерьеров жилых домов, квартир и коммерческих объектов с учетом всех  необходимых технических расчетов.
                                </p>
                            </div>
                            <div class="about__column-item">
                                <p class="column-item-tile">
                                    Мы стремимся создавать и воплощать эстетический, современный и функциональный дизайн. Мы всегда открыты для новых задач в проектировании и реализации вашей мечты.
                                </p>
                            </div>
                        </div>
                        <div class="about__column-info">
                            <div class="about__column-item">
                                ...
                                <p class="about__column-subtitle">лет работы нашей студии</p>
                            </div>
                            <div class="about__column-item">
                    ...
                    <div class="profit__column">
                        <div class="profit__item">
                            ...
                            <div class="profit__text">
                                <p>Полный цикл - реализация проектов под ключ, любой сложности. Полная комплектация объекта. </p>
                            </div>
                        </div>
                        <div class="profit__item">
                            <div class="profit__subtitle">
                            ...
                            <div class="profit__text">
                                <p>Работая на рынке с 2010 года, мы точно знаем все подводные камни создания реализации дизайн-проекта, с учетом всех пожеланий и технических требований.</p>
                            </div>
                        </div>
                        <div class="profit__item">
                            <div class="profit__subtitle">
                            ...
                            <div class="profit__text">
                                <p>Оценим стоимость материалов и работ на всех этапах, что позволит уложиться в заданный бюджет</p>
                            </div>
                        </div>
                        <div class="profit__item">
                            <div class="profit__subtitle">
                            ...
                            <div class="profit__text">
                                <p>Точные технические просчеты позволят выполнить строительные работы без ошибок и переделок, экономя при этом время и деньги.</p>
                            </div>
                        </div>
                    </div>
